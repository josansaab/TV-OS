...
import { Play, Music, Youtube, ShoppingBag, Video, Tv, HardDrive, Download } from 'lucide-react';
import { motion } from 'framer-motion';

const apps = [
  { id: 'plex', title: 'Plex', color: 'linear-gradient(135deg, #e5a00d 0%, #b57d08 100%)', icon: <Play className="w-12 h-12 text-white" fill="white" />, wide: true },
  { id: 'netflix', title: 'Netflix', color: 'linear-gradient(135deg, #E50914 0%, #B20710 100%)', icon: <span className="text-5xl font-black text-red-600 tracking-tighter">N</span> },
  { id: 'prime', title: 'Prime Video', color: 'linear-gradient(135deg, #00A8E1 0%, #0078A0 100%)', icon: <ShoppingBag className="w-10 h-10 text-white" /> },
  { id: 'spotify', title: 'Spotify', color: 'linear-gradient(135deg, #1DB954 0%, #191414 100%)', icon: <Music className="w-10 h-10 text-white" /> },
  { id: 'youtube', title: 'YouTube', color: 'linear-gradient(135deg, #FF0000 0%, #CC0000 100%)', icon: <Youtube className="w-12 h-12 text-white" /> },
  { id: 'kodi', title: 'Kodi', color: 'linear-gradient(135deg, #17B2E7 0%, #0F8AB5 100%)', icon: <Tv className="w-10 h-10 text-white" /> },
  { id: 'kayo', title: 'Kayo Sports', color: 'linear-gradient(135deg, #00C365 0%, #008F4A 100%)', icon: <span className="text-3xl font-bold italic">K</span> },
  { id: 'freetube', title: 'FreeTube', color: 'linear-gradient(135deg, #364F6B 0%, #1E2A38 100%)', icon: <Video className="w-10 h-10 text-white" /> },
  { id: 'vaccum', title: 'VacuumTube', color: 'linear-gradient(135deg, #6B364F 0%, #381E2A 100%)', icon: <Video className="w-10 h-10 text-pink-300" /> },
  { id: 'chaupal', title: 'Chaupal', color: 'linear-gradient(135deg, #FF512F 0%, #DD2476 100%)', icon: <span className="text-2xl font-bold">C</span> },
];
